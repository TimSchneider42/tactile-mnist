...
from typing import Iterable, Union, List, Set, Dict, Literal, Tuple
...
class MeshDataset(
    ...
    def filter_labels(self, labels: Union[int, Iterable[int]]) -> "MeshDataset":
    ...
    @staticmethod
    def load(path: Path, cache_size: Union[int, Literal["full"]] = 0) -> "MeshDataset":
