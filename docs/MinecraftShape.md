...
|-------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| MinecraftShape-DR-v0 | Same as MinecraftShape-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. | <img src="img/env/MinecraftShape-DR-v0.webp" alt="MinecraftShape-DR-v0" width="200px"/> |
...
| MinecraftShape-Depth-DR-v0 | Same as MinecraftShape-Depth-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. | <img src="img/env/MinecraftShape-Depth-DR-v0.webp" alt="MinecraftShape-Depth-DR-v0" width="200px"/> |
