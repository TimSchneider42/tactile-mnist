...
| ABCVolume-DR-v0 | Same as ABCVolume-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. ABCVolume-DR-train-v0 is an alias for it. | <img src="img/env/ABCVolume-DR-v0.webp" alt="ABCVolume-DR-v0" width="200px"/> |
...
| ABCVolume-DR-test-v0 | Same as ABCVolume-test-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. | <img src="img/env/ABCVolume-DR-test-v0.webp" alt="ABCVolume-DR-test-v0" width="200px"/> |
| ABCVolume-CycleGAN-train-v0 | Uses a [CycleGAN](https://junyanz.github.io/CycleGAN/) trained on data points from the [Real Tactile MNIST](datasets.md#available-touch-datasets) dataset instead of Taxim to render the tactile images. | <img src="img/env/ABCVolume-CycleGAN-v0.webp" alt="ABCVolume-CycleGAN-v0" width="200px"/> |
| ABCVolume-CycleGAN-DR-v0 | Same as ABCVolume-CycleGAN-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. ABCVolume-CycleGAN-DR-train-v0 is an alias for it. | <img src="img/env/ABCVolume-CycleGAN-DR-v0.webp" alt="ABCVolume-CycleGAN-DR-v0" width="200px"/> |
| ABCVolume-CycleGAN-test-v0 | Same as ABCVolume-CycleGAN-train-v0 but uses the test split of the _ABC Dataset_ instead of the train split. | <img src="img/env/ABCVolume-CycleGAN-test-v0.webp" alt="ABCVolume-CycleGAN-test-v0" width="200px"/> |
| ABCVolume-CycleGAN-DR-test-v0 | Same as ABCVolume-CycleGAN-test-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. | <img src="img/env/ABCVolume-CycleGAN-DR-test-v0.webp" alt="ABCVolume-CycleGAN-DR-test-v0" width="200px"/> |
...
| ABCVolume-Depth-DR-v0 | Same as ABCVolume-Depth-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. ABCVolume-Depth-DR-train-v0 is an alias for it. | <img src="img/env/ABCVolume-Depth-DR-v0.webp" alt="ABCVolume-Depth-DR-v0" width="200px"/> |
...
| ABCVolume-Depth-DR-test-v0 | Same as ABCVolume-Depth-test-v0 but with [domain randomization](TactilePerceptionConfig.md#sensor-noise) enabled. | <img src="img/env/ABCVolume-Depth-DR-test-v0.webp" alt="ABCVolume-Depth-DR-test-v0" width="200px"/> |
