...
| Starstruck-Depth-test-v0  | Same as Starstruck-Depth-train-v0 but uses the test split of _Starstruck_ instead of the train split. | <img src="img/env/Starstruck-Depth-test-v0.gif" alt="Starstruck-Depth-test-v0" width="200px"/> |
